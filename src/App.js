        ...
        <Container>
          <Row>
            ...
            <Col sm={{ span: 3, offset: 1 }} xs={6}>
              <Link style={{ textDecoration: "none" }} to="/about">
                <div className="tile">
                  <div className="tileContent">Work</div>
                </div>
              </Link>
            </Col>
            <Col sm={3} xs={6}>
              <Link style={{ textDecoration: "none" }} to="/about">
                <div className="tile">
                  <div className="tileContent">Services</div>
                </div>
              </Link>
            </Col>
            <Col sm={3} xs={6}>
            ...
            <Col sm={{ span: 3, offset: 1 }} xs={6}>
              <Link style={{ textDecoration: "none" }} to="/about">
                <div className="tile">
                  <div className="tileContent">Clients</div>
                </div>
              </Link>
            </Col>
            <Col sm={3} xs={6}>
              <Link style={{ textDecoration: "none" }} to="/about">
                <div className="tile">
                  <div className="tileContent">Testimonials</div>
                </div>
              </Link>
            </Col>
            <Col sm={3} xs={6}>
